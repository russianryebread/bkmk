...
Secrets are encrypted notes that require a password to access content.
  ...
  "notes": [
    {
      ...
      "createdAt": "2024-01-15T10:30:00Z",
      "updatedAt": "2024-01-16T08:00:00Z",
      "lastAccessedAt": "2024-01-16T08:00:00Z"
    }
  ]
}
```

**Note:** Content is never returned in list view.
...
```
GET /api/notes/secret/:id?password=secret123
```

**Without password:** Returns metadata only
```json
{
  "id": "uuid",
  "title": "API Keys",
...
**With incorrect password:** Returns 401
...
**Note:** `current_password` is required when changing `content` or `password`.
