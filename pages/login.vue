        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <div class="space-y-3">
            ...
            <button
              ...
              :disabled="loading"
              class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            >
              ...
              <span class="font-medium text-gray-700 dark:text-gray-200">GitHub</span>
            </button> -->
          </div>
...
const { login, isAuthenticated, isLoading, init, signInWithOAuth } = useAuth()
