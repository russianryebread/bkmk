  ...
  <div class="max-w-2xl mx-auto">
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
      <button @click="handleLogout"
        class="w-full btn-primary text-red-600 bg-transparent hover:bg-red-100 dark:bg-red-900 dark:text-red-400 dark:hover:bg-red-800">
    ...
    <div class="mt-8 text-center">
      <p class="text-xs text-gray-400 dark:text-gray-500">
        <a href="https://hoshor.me" target="_blank" class="text-primary-600 dark:text-primary-400 hover:underline">Built
          in Colorado</a> <span class="text-lg">🏔️</span> | {{ version.slice(0, 7) }}
      </p>
    </div>
  </div>
</template>
